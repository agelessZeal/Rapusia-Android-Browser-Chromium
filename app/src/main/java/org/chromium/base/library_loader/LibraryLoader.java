...
public class LibraryLoader {
    ...
    public static boolean useCrazyLinker() {
        ...
        Log.i("Pj","useCrazyLinker  NativeLibraries.sUseLinker %b ",NativeLibraries.sUseLinker);
    ...
    private static boolean isInZipFile() {
        ...
        Log.i("Pj","isInZipFile  NativeLibraries.sUseLibraryInZipFile %b ",NativeLibraries.sUseLibraryInZipFile);
    ...
    private void loadLibraryWithCustomLinkerAlreadyLocked(
        ...
        Log.i("Pj","loadLibraryWithCustomLinkerAlreadyLocked 375 libFilePath=%s",libFilePath);
        if (linker.isUsingBrowserSharedRelros()) {
            ...
            Log.i("Pj","loadLibraryWithCustomLinkerAlreadyLocked 375 isUsingBrowserSharedRelros");
            ...
            Log.i("Pj","loadLibraryWithCustomLinkerAlreadyLocked 375 linker.loadLibrary  libFilePath=%s",libFilePath);
    ...
    static String getExtractedLibraryPath(Context appContext, String libName) {
        ...
        Log.i("Pj","getExtractedLibraryPath %libname =%s  libraryEntry =" +libraryEntry);
        ...
        try (TraceEvent te = TraceEvent.scoped("LibraryLoader.loadAlreadyLocked")) {
            if (!mLoaded) {
                ...
                if (useCrazyLinker()) {
                    ...
                    Log.i("Pj","loadAlreadyLocked  useCrazyLinker()");
                    ...
                    Log.i("Pj","call linker.prepareLibraryLoad  apkFilePath =%s",apkFilePath);
                    ...
                    for (String library : NativeLibraries.LIBRARIES) {
                        ...
                        if (apkFilePath != null) {
                            ...
                            Log.i("Pj","apkFilePath=%s",apkFilePath);
                        } else {
                        ...
                        try {
                            ...
                            Log.i("Pj", "before loadLibraryWithCustomLinkerAlreadyLocked. libFilePath=%s",libFilePath );
                            ...
                            Log.i("Pj", "Loading UnsatisfiedLinkError with getExtractedLibraryPath" );
                    ...
                    setEnvForNative();
                    preloadAlreadyLocked(appContext);
                    Log.i("Pj","loadAlreadyLocked  preloadAlreadyLocked after ");
                    ...
                    for (String library : NativeLibraries.LIBRARIES) {
                        try {
                            if (!isInZipFile()) {
                                ...
                                Log.i("Pj"," call System.loadLibrary(library); library=%s ",library);
                                System.loadLibrary(library);
                            } else {

                                Log.i("Pj"," // Load directly from the APK. ");
                                ...
                                Log.i("Pj", "before  System.load(libraryName) libraryName: " + libraryName);
...
//                cpuAbi = "armeabi-v7a";
    ...
    private void initializeAlreadyLocked(@LibraryProcessType int processType)
        ...
        Log.i("Pj","initializeAlreadyLocked processType %d",processType);
        if (mInitialized) {
        ...
        if (!nativeLibraryLoaded(mLibraryProcessType)) {
            ...
            Log.i("Pj","error calling nativeLibraryLoaded mLibraryProcessType %d",mLibraryProcessType);
