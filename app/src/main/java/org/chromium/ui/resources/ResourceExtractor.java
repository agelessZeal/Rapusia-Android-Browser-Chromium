...
public class ResourceExtractor {
    ...
    private static final String V8_SNAPSHOT_DATA_FILENAME = "snapshot_blob_64.bin";
    private static final String V8_SNAPSHOT_DATA_FILENAME_32 = "snapshot_blob_32.bin";
